...
| Presentation | ![](https://geps.dev/progress/90) | Maybe make some small imporvements |
...
The goal of the project is to design online learning algorithms to sell multiple types of products under production constraints. See [the offcial slides](project.pdf) for detailed information.
#### Parameters
- Number of rounds T
